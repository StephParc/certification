...
def create_substitution(data: SubstitutionSchema, current_user = Depends(get_current_user)):
...
def delete_substitution(rule_id: str, current_user = Depends(get_current_user)):
