...
- Les indicateurs de service se basent sur les SLA.
...
- Les procédures et détails sur les traitements de conformité (automatisés ou non) à appliquer ainsi que leur fréquence d’exécution.
